...
from mongo import test_insert_mongo, create_data_for_insert_mongo,create_collections, drop_collections,find_all_id_filmworks, test_expected_value_mongo
from postgres import test_insert_postgres, create_database, drop_database, create_data_for_insert_postgres, test_expected_value_postgres
...
def start_test_insert():
    ...
    data = create_data_for_insert_mongo(count_filmwork=count_filmwork, count_scores=count_scores, count_reviews=count_reviews,
                                        count_like_reviews=count_like_reviews,
                                        size_header= size_header,size_text=size_text,count_user=count_user,
